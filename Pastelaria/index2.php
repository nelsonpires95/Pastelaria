      ...
      <div id="menu">
        ...
        <div id="grupos">
          ...
          <form action="informacoes.php" method="POST">
            <p><i class="fa fa-user"></i> <input disabled type="button" name="empregados" value="Empregados" onclick="window.open('empregados.php', 'windowE', 'width=1000, height=450, left=500 top=250'); return false;"></p>
            <p><i class="fa fa-user"></i> <input disabled type="button" name="clientes" value="Clientes" onclick="window.open('clientes.php', 'windowC', 'width=1000, height=450, left=500 top=250'); return false;"></p>
            <p><i class="fa fa-bars"></i> <input disabled type="button" name="produtos" value="Produtos" onclick="window.open('produtos.php', 'windowF', 'width=1000, height=450, left=500 top=250'); return false;"></p>
            <p><i class="fa fa-truck"></i> <input disabled type="button" name="fornecedores" value="Fornecedores" onclick="window.open('fornecedores.php', 'windowF', 'width=1000, height=450, left=500 top=250'); return false;"></p>
          </form>
        </div>
      </div>
